export const ERROR_MESSAGE = {
    ...
    isAlphabet: (name: string, {...args}): string => `${name} should be alphabets`,
    isSmallCase: (name: string, {...args}): string => `${name} should be smallcase charecters`,
    isLargeCase: (name: string, {...args}): string => `${name} should be largecase charecters`,
    isNumeric: (name: string, {...args}): string => `${name} should be number`,
    isCode: (name: string, {...args}): string => `${name} should be alphanumeric`,
